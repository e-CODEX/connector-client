...
== Content of the client-libraries package
...
[link=../resources/images/connectorClientPackageContent.png,window=_tab]
image:connectorClientPackageContent.png[client-libraries-package-content]
