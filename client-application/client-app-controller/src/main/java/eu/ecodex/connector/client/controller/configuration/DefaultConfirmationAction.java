 ...
 */
@Data
@ConfigurationProperties(prefix = DomibusConnectorClientControllerConfig.PREFIX + "." + DefaultConfirmationAction.PREFIX )
public class DefaultConfirmationAction {
    public static final String PREFIX = "default-confirmation-action";
