...
[link={basepath}/resources/images/domibusConnectorClientApplication.png,window=_tab]
image:domibusConnectorClientApplication.png[client-application]
...
[link={basepath}/resources/images/domibusConnectorClientController.png,window=_tab]
image:domibusConnectorClientController.png[client-app-controller,600]
...
[link={basepath}/resources/images/domibusConnectorClientFSStorage.png,window=_tab]
image:domibusConnectorClientFSStorage.png[client-app-fs-storage]
...
[link={basepath}/resources/images/domibusConnectorClientRestAPI.png,window=_tab]
image:domibusConnectorClientRestAPI.png[client-app-rest-api]
...
[link={basepath}/resources/images/domibusConnectorClientStarter.png,window=_tab]
image:domibusConnectorClientStarter.png[client-app-starter]
