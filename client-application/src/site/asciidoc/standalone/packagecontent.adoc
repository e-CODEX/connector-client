...
[link={basepath}/resources/images/packagecontent_standalone.png,window=_tab]
image:packagecontent_standalone.png[connector-client-distribution standalone content]
