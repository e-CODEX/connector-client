...
== Installation guide for the connector-client standalone application
...
# for versions below 6.0.2, use
# spring.codec.max-in-memory-size=20MB
# from version 6.0.2 onwards, use
spring.http.codec.max-in-memory-size=20MB
----
