...
[link={basepath}/../resources/images/packagecontent_webapp.png,window=_tab]
image:packagecontent_webapp.png[connector-client-distribution deployable package content]
