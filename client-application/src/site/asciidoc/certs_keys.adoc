...
[link={basepath}/resources/images/domibusConnectorClient_keys_stores.png,window=_tab]
image:domibusConnectorClient_keys_stores.png[client-application required keys]
